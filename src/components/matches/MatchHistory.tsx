...
export function MatchHistory({ teams, matches }: MatchHistoryProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t.h2hHistory}</CardTitle>
        <CardDescription>{t.h2hHistoryDescription}</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex justify-around text-center p-4 rounded-lg bg-muted">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">{team1Name} {t.wins}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">{team2Name} {t.wins}</p>
                </div>
            </div>
            ...
            <Table>
              ...
              <TableBody>
                {filteredMatches.length === 0 && (
                    <TableRow><TableCell colSpan={5} className="text-center">{t.noMatchesFound}</TableCell></TableRow>
                )}
